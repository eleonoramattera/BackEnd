	...
	for(int i=0; i<=m1.length; i++) {
		...
		System.out.println("Inserisci che tipo di elemento visualizzare: \n 1- immagine, 2-video, 3-audio");
 		...
 		case 1 :
 		    ...
 		    s.nextLine();
 		    Immagine im = new Immagine (titolo,luminositaImg);
 		...
 		case 2:
 			...
 			s.nextLine();
 			Video vid = new Video(titolo, volumeVideo, durataVideo, luminVideo);
 		...
 		case 3:
 			...
 			s.nextLine();
 			Audio aud = new Audio(titolo, volumeAudio, durataAudio);
